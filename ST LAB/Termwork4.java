...
public class Termwork4 {
    public static  void main(String agrs[]){
       ...
       int lock_price=sc.nextInt();//45
       int stock_price=sc.nextInt();//30
       int barrel_price=sc.nextInt();//25
       System.out.println("Initialize production limit of lock,stock,barrel");
       int lock_limit=sc.nextInt();//70
       int stock_limit= sc.nextInt();//80
       int barrel_limit=sc.nextInt();//90
       System.out.println("Initialize Commission levels ");
       double commission_level1=sc.nextDouble();//0.10
        double commission_level2=sc.nextDouble();//0.15
        double commission_level3=sc.nextDouble();//0.20
